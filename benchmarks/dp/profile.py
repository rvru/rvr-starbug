...
def main():
    ...
    for length in LENGTHS:
        ...
        run_commands = [
            ("vliw",
             f"bazel run :rv32_vliw_sim -- --semihost_arm \"$(realpath ../benchmarks/dp/dp_vliw.elf)\""),
            ("scalar",
             f"bazel run :rv32g_sim -- --semihost_arm \"$(realpath ../benchmarks/dp/dp_scalar.elf)\""),
            ("empty",
             f"bazel run :rv32g_sim -- --semihost_arm \"$(realpath ../benchmarks/dp/dp_empty.elf)\""),
        ]
